...
namespace CRM.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            // add role Sale, PM, Accountant

            var saleRole = _context.Roles.IgnoreQueryFilters().FirstOrDefault(r => r.TenantId == null && r.Name == StaticRoleNames.Tenants.Sale);
            if (saleRole == null)
            {
                saleRole = _context.Roles.Add(new Role(null, StaticRoleNames.Tenants.Sale, StaticRoleNames.Tenants.Sale)).Entity;
                _context.SaveChanges();
            }
            ...
            if (pmRole == null)
            {
                pmRole = _context.Roles.Add(new Role(null, StaticRoleNames.Tenants.PM, StaticRoleNames.Tenants.PM)).Entity;
                _context.SaveChanges();
            }
            ...
            {
                accountantRole = _context.Roles.Add(new Role(null, StaticRoleNames.Tenants.Accountant, StaticRoleNames.Tenants.Accountant)).Entity;
                _context.SaveChanges();
            }
        }
    }
